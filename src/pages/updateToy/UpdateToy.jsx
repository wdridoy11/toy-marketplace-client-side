...
const UpdateToy = () => {
    ...
    const {_id, price,quantity,description,name} = toyUpdateData;
      ...
      <div className='w-1/2 mx-auto border p-10 rounded-lg'>
          <form onSubmit={handleUpdateData}>
              ...
              <div className='mb-3'>
                  ...
                  <input type="text" name='price' id='price' placeholder="Price" defaultValue={price} className="input input-bordered w-full" required/>
              </div>
              <div className='mb-3'>
                  <label className="label">
              ...
              <input type="submit" className='py-3 cursor-pointer px-10 bg-orange-400 text-white font-semibold rounded-md text-base hover:bg-black duration-500' value="Update Toy" />
          </form>
      </div>
    </div>
  </div>
